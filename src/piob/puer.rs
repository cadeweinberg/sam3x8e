...
impl W {
    ...
    #[inline(always)]
    pub fn p0(&mut self) -> P0W<'_, PuerSpec> {
        P0W::new(self, 0)
    }
    #[doc = "Bit 1 - Pull Up Enable."]
    #[inline(always)]
    pub fn p1(&mut self) -> P1W<'_, PuerSpec> {
        P1W::new(self, 1)
    }
    #[doc = "Bit 2 - Pull Up Enable."]
    #[inline(always)]
    pub fn p2(&mut self) -> P2W<'_, PuerSpec> {
        P2W::new(self, 2)
    }
    #[doc = "Bit 3 - Pull Up Enable."]
    #[inline(always)]
    pub fn p3(&mut self) -> P3W<'_, PuerSpec> {
        P3W::new(self, 3)
    }
    #[doc = "Bit 4 - Pull Up Enable."]
    #[inline(always)]
    pub fn p4(&mut self) -> P4W<'_, PuerSpec> {
        P4W::new(self, 4)
    }
    #[doc = "Bit 5 - Pull Up Enable."]
    #[inline(always)]
    pub fn p5(&mut self) -> P5W<'_, PuerSpec> {
        P5W::new(self, 5)
    }
    #[doc = "Bit 6 - Pull Up Enable."]
    #[inline(always)]
    pub fn p6(&mut self) -> P6W<'_, PuerSpec> {
        P6W::new(self, 6)
    }
    #[doc = "Bit 7 - Pull Up Enable."]
    #[inline(always)]
    pub fn p7(&mut self) -> P7W<'_, PuerSpec> {
        P7W::new(self, 7)
    }
    #[doc = "Bit 8 - Pull Up Enable."]
    #[inline(always)]
    pub fn p8(&mut self) -> P8W<'_, PuerSpec> {
        P8W::new(self, 8)
    }
    #[doc = "Bit 9 - Pull Up Enable."]
    #[inline(always)]
    pub fn p9(&mut self) -> P9W<'_, PuerSpec> {
        P9W::new(self, 9)
    }
    #[doc = "Bit 10 - Pull Up Enable."]
    #[inline(always)]
    pub fn p10(&mut self) -> P10W<'_, PuerSpec> {
        P10W::new(self, 10)
    }
    #[doc = "Bit 11 - Pull Up Enable."]
    #[inline(always)]
    pub fn p11(&mut self) -> P11W<'_, PuerSpec> {
        P11W::new(self, 11)
    }
    #[doc = "Bit 12 - Pull Up Enable."]
    #[inline(always)]
    pub fn p12(&mut self) -> P12W<'_, PuerSpec> {
        P12W::new(self, 12)
    }
    #[doc = "Bit 13 - Pull Up Enable."]
    #[inline(always)]
    pub fn p13(&mut self) -> P13W<'_, PuerSpec> {
        P13W::new(self, 13)
    }
    #[doc = "Bit 14 - Pull Up Enable."]
    #[inline(always)]
    pub fn p14(&mut self) -> P14W<'_, PuerSpec> {
        P14W::new(self, 14)
    }
    #[doc = "Bit 15 - Pull Up Enable."]
    #[inline(always)]
    pub fn p15(&mut self) -> P15W<'_, PuerSpec> {
        P15W::new(self, 15)
    }
    #[doc = "Bit 16 - Pull Up Enable."]
    #[inline(always)]
    pub fn p16(&mut self) -> P16W<'_, PuerSpec> {
        P16W::new(self, 16)
    }
    #[doc = "Bit 17 - Pull Up Enable."]
    #[inline(always)]
    pub fn p17(&mut self) -> P17W<'_, PuerSpec> {
        P17W::new(self, 17)
    }
    #[doc = "Bit 18 - Pull Up Enable."]
    #[inline(always)]
    pub fn p18(&mut self) -> P18W<'_, PuerSpec> {
        P18W::new(self, 18)
    }
    #[doc = "Bit 19 - Pull Up Enable."]
    #[inline(always)]
    pub fn p19(&mut self) -> P19W<'_, PuerSpec> {
        P19W::new(self, 19)
    }
    #[doc = "Bit 20 - Pull Up Enable."]
    #[inline(always)]
    pub fn p20(&mut self) -> P20W<'_, PuerSpec> {
        P20W::new(self, 20)
    }
    #[doc = "Bit 21 - Pull Up Enable."]
    #[inline(always)]
    pub fn p21(&mut self) -> P21W<'_, PuerSpec> {
        P21W::new(self, 21)
    }
    #[doc = "Bit 22 - Pull Up Enable."]
    #[inline(always)]
    pub fn p22(&mut self) -> P22W<'_, PuerSpec> {
        P22W::new(self, 22)
    }
    #[doc = "Bit 23 - Pull Up Enable."]
    #[inline(always)]
    pub fn p23(&mut self) -> P23W<'_, PuerSpec> {
        P23W::new(self, 23)
    }
    #[doc = "Bit 24 - Pull Up Enable."]
    #[inline(always)]
    pub fn p24(&mut self) -> P24W<'_, PuerSpec> {
        P24W::new(self, 24)
    }
    #[doc = "Bit 25 - Pull Up Enable."]
    #[inline(always)]
    pub fn p25(&mut self) -> P25W<'_, PuerSpec> {
        P25W::new(self, 25)
    }
    #[doc = "Bit 26 - Pull Up Enable."]
    #[inline(always)]
    pub fn p26(&mut self) -> P26W<'_, PuerSpec> {
        P26W::new(self, 26)
    }
    #[doc = "Bit 27 - Pull Up Enable."]
    #[inline(always)]
    pub fn p27(&mut self) -> P27W<'_, PuerSpec> {
        P27W::new(self, 27)
    }
    #[doc = "Bit 28 - Pull Up Enable."]
    #[inline(always)]
    pub fn p28(&mut self) -> P28W<'_, PuerSpec> {
        P28W::new(self, 28)
    }
    #[doc = "Bit 29 - Pull Up Enable."]
    #[inline(always)]
    pub fn p29(&mut self) -> P29W<'_, PuerSpec> {
        P29W::new(self, 29)
    }
    #[doc = "Bit 30 - Pull Up Enable."]
    #[inline(always)]
    pub fn p30(&mut self) -> P30W<'_, PuerSpec> {
        P30W::new(self, 30)
    }
    #[doc = "Bit 31 - Pull Up Enable."]
    #[inline(always)]
    pub fn p31(&mut self) -> P31W<'_, PuerSpec> {
        P31W::new(self, 31)
    }
}
