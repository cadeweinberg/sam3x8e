...
impl W {
    ...
    #[inline(always)]
    pub fn p0(&mut self) -> P0W<'_, MderSpec> {
        P0W::new(self, 0)
    }
    #[doc = "Bit 1 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p1(&mut self) -> P1W<'_, MderSpec> {
        P1W::new(self, 1)
    }
    #[doc = "Bit 2 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p2(&mut self) -> P2W<'_, MderSpec> {
        P2W::new(self, 2)
    }
    #[doc = "Bit 3 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p3(&mut self) -> P3W<'_, MderSpec> {
        P3W::new(self, 3)
    }
    #[doc = "Bit 4 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p4(&mut self) -> P4W<'_, MderSpec> {
        P4W::new(self, 4)
    }
    #[doc = "Bit 5 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p5(&mut self) -> P5W<'_, MderSpec> {
        P5W::new(self, 5)
    }
    #[doc = "Bit 6 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p6(&mut self) -> P6W<'_, MderSpec> {
        P6W::new(self, 6)
    }
    #[doc = "Bit 7 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p7(&mut self) -> P7W<'_, MderSpec> {
        P7W::new(self, 7)
    }
    #[doc = "Bit 8 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p8(&mut self) -> P8W<'_, MderSpec> {
        P8W::new(self, 8)
    }
    #[doc = "Bit 9 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p9(&mut self) -> P9W<'_, MderSpec> {
        P9W::new(self, 9)
    }
    #[doc = "Bit 10 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p10(&mut self) -> P10W<'_, MderSpec> {
        P10W::new(self, 10)
    }
    #[doc = "Bit 11 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p11(&mut self) -> P11W<'_, MderSpec> {
        P11W::new(self, 11)
    }
    #[doc = "Bit 12 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p12(&mut self) -> P12W<'_, MderSpec> {
        P12W::new(self, 12)
    }
    #[doc = "Bit 13 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p13(&mut self) -> P13W<'_, MderSpec> {
        P13W::new(self, 13)
    }
    #[doc = "Bit 14 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p14(&mut self) -> P14W<'_, MderSpec> {
        P14W::new(self, 14)
    }
    #[doc = "Bit 15 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p15(&mut self) -> P15W<'_, MderSpec> {
        P15W::new(self, 15)
    }
    #[doc = "Bit 16 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p16(&mut self) -> P16W<'_, MderSpec> {
        P16W::new(self, 16)
    }
    #[doc = "Bit 17 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p17(&mut self) -> P17W<'_, MderSpec> {
        P17W::new(self, 17)
    }
    #[doc = "Bit 18 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p18(&mut self) -> P18W<'_, MderSpec> {
        P18W::new(self, 18)
    }
    #[doc = "Bit 19 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p19(&mut self) -> P19W<'_, MderSpec> {
        P19W::new(self, 19)
    }
    #[doc = "Bit 20 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p20(&mut self) -> P20W<'_, MderSpec> {
        P20W::new(self, 20)
    }
    #[doc = "Bit 21 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p21(&mut self) -> P21W<'_, MderSpec> {
        P21W::new(self, 21)
    }
    #[doc = "Bit 22 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p22(&mut self) -> P22W<'_, MderSpec> {
        P22W::new(self, 22)
    }
    #[doc = "Bit 23 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p23(&mut self) -> P23W<'_, MderSpec> {
        P23W::new(self, 23)
    }
    #[doc = "Bit 24 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p24(&mut self) -> P24W<'_, MderSpec> {
        P24W::new(self, 24)
    }
    #[doc = "Bit 25 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p25(&mut self) -> P25W<'_, MderSpec> {
        P25W::new(self, 25)
    }
    #[doc = "Bit 26 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p26(&mut self) -> P26W<'_, MderSpec> {
        P26W::new(self, 26)
    }
    #[doc = "Bit 27 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p27(&mut self) -> P27W<'_, MderSpec> {
        P27W::new(self, 27)
    }
    #[doc = "Bit 28 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p28(&mut self) -> P28W<'_, MderSpec> {
        P28W::new(self, 28)
    }
    #[doc = "Bit 29 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p29(&mut self) -> P29W<'_, MderSpec> {
        P29W::new(self, 29)
    }
    #[doc = "Bit 30 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p30(&mut self) -> P30W<'_, MderSpec> {
        P30W::new(self, 30)
    }
    #[doc = "Bit 31 - Multi Drive Enable."]
    #[inline(always)]
    pub fn p31(&mut self) -> P31W<'_, MderSpec> {
        P31W::new(self, 31)
    }
}
