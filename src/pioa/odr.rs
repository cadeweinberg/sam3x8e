...
impl W {
    ...
    #[inline(always)]
    pub fn p0(&mut self) -> P0W<'_, OdrSpec> {
        P0W::new(self, 0)
    }
    #[doc = "Bit 1 - Output Disable"]
    #[inline(always)]
    pub fn p1(&mut self) -> P1W<'_, OdrSpec> {
        P1W::new(self, 1)
    }
    #[doc = "Bit 2 - Output Disable"]
    #[inline(always)]
    pub fn p2(&mut self) -> P2W<'_, OdrSpec> {
        P2W::new(self, 2)
    }
    #[doc = "Bit 3 - Output Disable"]
    #[inline(always)]
    pub fn p3(&mut self) -> P3W<'_, OdrSpec> {
        P3W::new(self, 3)
    }
    #[doc = "Bit 4 - Output Disable"]
    #[inline(always)]
    pub fn p4(&mut self) -> P4W<'_, OdrSpec> {
        P4W::new(self, 4)
    }
    #[doc = "Bit 5 - Output Disable"]
    #[inline(always)]
    pub fn p5(&mut self) -> P5W<'_, OdrSpec> {
        P5W::new(self, 5)
    }
    #[doc = "Bit 6 - Output Disable"]
    #[inline(always)]
    pub fn p6(&mut self) -> P6W<'_, OdrSpec> {
        P6W::new(self, 6)
    }
    #[doc = "Bit 7 - Output Disable"]
    #[inline(always)]
    pub fn p7(&mut self) -> P7W<'_, OdrSpec> {
        P7W::new(self, 7)
    }
    #[doc = "Bit 8 - Output Disable"]
    #[inline(always)]
    pub fn p8(&mut self) -> P8W<'_, OdrSpec> {
        P8W::new(self, 8)
    }
    #[doc = "Bit 9 - Output Disable"]
    #[inline(always)]
    pub fn p9(&mut self) -> P9W<'_, OdrSpec> {
        P9W::new(self, 9)
    }
    #[doc = "Bit 10 - Output Disable"]
    #[inline(always)]
    pub fn p10(&mut self) -> P10W<'_, OdrSpec> {
        P10W::new(self, 10)
    }
    #[doc = "Bit 11 - Output Disable"]
    #[inline(always)]
    pub fn p11(&mut self) -> P11W<'_, OdrSpec> {
        P11W::new(self, 11)
    }
    #[doc = "Bit 12 - Output Disable"]
    #[inline(always)]
    pub fn p12(&mut self) -> P12W<'_, OdrSpec> {
        P12W::new(self, 12)
    }
    #[doc = "Bit 13 - Output Disable"]
    #[inline(always)]
    pub fn p13(&mut self) -> P13W<'_, OdrSpec> {
        P13W::new(self, 13)
    }
    #[doc = "Bit 14 - Output Disable"]
    #[inline(always)]
    pub fn p14(&mut self) -> P14W<'_, OdrSpec> {
        P14W::new(self, 14)
    }
    #[doc = "Bit 15 - Output Disable"]
    #[inline(always)]
    pub fn p15(&mut self) -> P15W<'_, OdrSpec> {
        P15W::new(self, 15)
    }
    #[doc = "Bit 16 - Output Disable"]
    #[inline(always)]
    pub fn p16(&mut self) -> P16W<'_, OdrSpec> {
        P16W::new(self, 16)
    }
    #[doc = "Bit 17 - Output Disable"]
    #[inline(always)]
    pub fn p17(&mut self) -> P17W<'_, OdrSpec> {
        P17W::new(self, 17)
    }
    #[doc = "Bit 18 - Output Disable"]
    #[inline(always)]
    pub fn p18(&mut self) -> P18W<'_, OdrSpec> {
        P18W::new(self, 18)
    }
    #[doc = "Bit 19 - Output Disable"]
    #[inline(always)]
    pub fn p19(&mut self) -> P19W<'_, OdrSpec> {
        P19W::new(self, 19)
    }
    #[doc = "Bit 20 - Output Disable"]
    #[inline(always)]
    pub fn p20(&mut self) -> P20W<'_, OdrSpec> {
        P20W::new(self, 20)
    }
    #[doc = "Bit 21 - Output Disable"]
    #[inline(always)]
    pub fn p21(&mut self) -> P21W<'_, OdrSpec> {
        P21W::new(self, 21)
    }
    #[doc = "Bit 22 - Output Disable"]
    #[inline(always)]
    pub fn p22(&mut self) -> P22W<'_, OdrSpec> {
        P22W::new(self, 22)
    }
    #[doc = "Bit 23 - Output Disable"]
    #[inline(always)]
    pub fn p23(&mut self) -> P23W<'_, OdrSpec> {
        P23W::new(self, 23)
    }
    #[doc = "Bit 24 - Output Disable"]
    #[inline(always)]
    pub fn p24(&mut self) -> P24W<'_, OdrSpec> {
        P24W::new(self, 24)
    }
    #[doc = "Bit 25 - Output Disable"]
    #[inline(always)]
    pub fn p25(&mut self) -> P25W<'_, OdrSpec> {
        P25W::new(self, 25)
    }
    #[doc = "Bit 26 - Output Disable"]
    #[inline(always)]
    pub fn p26(&mut self) -> P26W<'_, OdrSpec> {
        P26W::new(self, 26)
    }
    #[doc = "Bit 27 - Output Disable"]
    #[inline(always)]
    pub fn p27(&mut self) -> P27W<'_, OdrSpec> {
        P27W::new(self, 27)
    }
    #[doc = "Bit 28 - Output Disable"]
    #[inline(always)]
    pub fn p28(&mut self) -> P28W<'_, OdrSpec> {
        P28W::new(self, 28)
    }
    #[doc = "Bit 29 - Output Disable"]
    #[inline(always)]
    pub fn p29(&mut self) -> P29W<'_, OdrSpec> {
        P29W::new(self, 29)
    }
    #[doc = "Bit 30 - Output Disable"]
    #[inline(always)]
    pub fn p30(&mut self) -> P30W<'_, OdrSpec> {
        P30W::new(self, 30)
    }
    #[doc = "Bit 31 - Output Disable"]
    #[inline(always)]
    pub fn p31(&mut self) -> P31W<'_, OdrSpec> {
        P31W::new(self, 31)
    }
}
